...
const About = () => {
  ...
  return (
    <div className={`flex h-screen ${themeClasses.mainBg} relative`}>
          ...
          <div className="mt-12 sm:mt-0">
            ...
            <div className={infoCardClass}>
              ...
              <p className="mb-2 text-center">
                Empowering students to build better habits, achieve their goals,
                and create lasting positive changes in their academic and
                personal lives.
              </p>
              <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="md:col-span-2 flex flex-col">
                <div className={`${cardClass} flex-1`}>
                  ...
                  >
                    We believe that small, consistent actions lead to
                    extraordinary results. Our Student Habit Tracker is designed
                    specifically for students who want to build productive
                    habits, improve their academic performance, and develop
                  ...
                  <ul className="mb-8 text-base space-y-6">
                    <li
                      className={`flex items-start gap-3 ${secondaryTextColor}`}
                    >
                      <span className="text-indigo-500 text-xl">📊</span>
                      <span>
                        <b>Smart Analytics:</b> Track your progress with
                        detailed charts and insights that help you understand
                        your habit patterns.
                      </span>
                    </li>
                    <li
                    ...
                    >
                      ...
                      <span>
                        <b>Achievement System:</b> Celebrate your wins with
                        streaks, badges, and milestone rewards.
                      </span>
                    </li>
                  </ul>
                  <h4 className={`font-semibold mb-4 ${mainTextColor} text-lg`}>
                  ...
                  >
                    ...
                    students. We understand the unique challenges of academic
                    life - from irregular schedules to exam stress. Our app
                    adapts to your student lifestyle, making habit building
